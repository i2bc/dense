...
DEV_MODE = True  # THIS IS FOR THE DEVELOPPER
...
def closest_genes_caller(
    ...
    if objs_format == "id":
        ...
        try:
            ...
            corrected_objs_lines = ['\t'.join(
                [objs_list[i], '-->', new_objs_list[i]]) for i in range(len(objs_list))]
        ...
        with open(gff_path) as gff:
            ...
            for line in gff:
                ...
                print("Here is a gff line {}".format(line))
                ...
                if line[0] != "#":
                    ...
                    try :
                        ...
                        print("Here is the problematic line : {}".format(line))
                        sys.exit()
                    if results:
        ...
        if new_objs_list:
            ...
            for i in range(len(objs_list)):
                ...
                if old_int != new_int:
                    ...
                    objs_genes_dic[old_int] = objs_genes_dic[new_int]
...
#        args.out = HOME + "PIPELINE/SYNTENY/output"
        args.gffA = HOME + "PIPELINE/work/43/0b4cb9bff1b9813a5ca312da285d0a/scer.gff"
        args.gffB = HOME + "PIPELINE/work/43/0b4cb9bff1b9813a5ca312da285d0a/sarb.gff"
        args.ortho = HOME + "PIPELINE/work/42/270d15a15a6e8abb3bf5579c953c3b/Scer_NCBI_Sarb_orthologs.tsv"
        args.list = HOME + "PIPELINE/work/43/0b4cb9bff1b9813a5ca312da285d0a/Scer_NCBI_vs_Sarb_synteny_pairs.tsv2"
        args.out = HOME + "PIPELINE/work/43/0b4cb9bff1b9813a5ca312da285d0a/test"
